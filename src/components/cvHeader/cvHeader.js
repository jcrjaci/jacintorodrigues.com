...
const OneDetail = ({ icon, link, description }) => (
  <DetailLine>
      {link ?
        <>
          <ExternalLink href={link} target="_blank" rel="noopener noreferrer" aria-label={description}>{icon}</ExternalLink>
          <ExternalLink href={link} target="_blank" rel="noopener noreferrer" aria-label={description}>{description}</ExternalLink>
        </>
        :
          <>
  ...
  <DetailLine>
    {icon.map((value, key) => (
      <React.Fragment key={description[key]}>
        <ExternalLink href={link[key]} target="_blank" rel="noopener noreferrer" aria-label={description[key]}>{icon[key]}</ExternalLink>
        <ExternalLink href={link[key]} target="_blank" rel="noopener noreferrer" aria-label={description[key]}>{description[key]}</ExternalLink>
      </ React.Fragment>
    ))}
  </DetailLine>
);
